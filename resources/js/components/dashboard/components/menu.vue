<template>
    <aside
        class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps ps--scrolling-y"
        id="sidenav-main"
        data-color="info"
        :style="sideNavStyles"
    >
        <div class="sidenav-header">
            ...
            >
                <div class="logo-container">
                    <img src="/images/small_logo.svg" alt="main_logo" />
                    <span class="ms-1 font-weight-bold"
                        >Intuition Business</span
                    >
                </div>
            </a>
        </div>
        ...
        >
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="#" @click="handleClickActiveNav">
                        <div
...
export default {
    ...
    methods: {
        ...
        handleClickActiveNav(event) {
            const navLink = document.querySelectorAll(".nav-link");
            const position = Array.from(navLink).indexOf(event.target);
            switch (position) {
                case 0:
